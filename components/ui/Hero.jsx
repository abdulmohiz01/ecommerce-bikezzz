      ...
      <div className="container mx-auto">
        <div className="flex items-center justify-between">
          ...
          <div className="w-full xl:max-w-[580px] md:h-[820px] flex flex-col justify-center items-start">
            ...
            <p className="mb-10 text-lg max-w-[508px] mx-auto text-center  xl:text-left xl:mx-0">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Enim harum, perferendis nostrum repudiandae exercitationem soluta velit. Quaerat recusandae corporis </p>
            {/* btn group */}
